...
public class Day2 {
    ...
    private static boolean isReportSafe(Integer[] report, int indexToOmit) {
        ...
        for (int i=lastIndex+1; i<report.length; i++)
        {
            ...
            if (!isLevelPairValid(lastLevel, report[i], isDecreasing)) {
                return false;
            }
            lastLevel = report[i];
        }
    ...
    private static boolean getIsDecreasing(Integer[] report, int indexToOmit) {
        if (indexToOmit == 0)
        {
            return report[1] > report[2];
        }
        else if (indexToOmit == 1)
        {
            return report[0] > report[2];
        }
        else
        {
    ...
    private static String getCustomInput() {
        return "10 12 9 8 7 6\n" +
                "6 5 8 9 10 11";
    }
}
